...
namespace lipsync_editor
{
		...
		: Form
	{
		...
		/// </summary>
		/// <remarks>pfe = path_file_extension</remarks>
		...
		/// by.
		/// </summary>
		/// <remarks>Used by Console only; the GUI will get the string directly
		/// from the currently selected item of the dropdown Combobox.</remarks>
		...
		/// </summary>
		/// <remarks>"def" or "default" actually means a basic/raw analysis - an
		/// analysis of the audio(file) without any typed text. The engine uses
		/// its default Dictation lexicon to find speech-patterns.</remarks>
		...
		/// </summary>
		/// <remarks>The engine uses a Rule based on typed-text to find speech-
		/// patterns.</remarks>
...
//			_sapi.SetRecognizer(recognizer);
		...
		/// </summary>
		/// <returns></returns>
		/// <remarks>The '_sapi._recognizer' needs to be re-created when the
		...
		/// call in
		/// <c><see cref="SapiLipsync.Start()">SapiLipsync.Start()</see></c> and
		/// unremark the call in
		/// <c><see cref="OnRecognizerChanged()">OnRecognizerChanged()</see></c>
		/// and use the app a bit. Things quickly go south on 2+ generations.</remarks>
...
//				grid_blocs.ClearSelection();
		...
		/// <summary>
		/// Switches stuff use to alternate/user-edited data.
		/// </summary>
		/// <param name="revert"><c>true</c> to revert to previous data</param>
		/// <seealso cref="EditorPhonF"><c>EditorPhonF</c></seealso>
		/// <remarks>The data in the "PHONEMES" table changes as data is edited
		/// in <c>EditorPhonF</c> so if that is canceled the table needs to
		/// revert.</remarks>
